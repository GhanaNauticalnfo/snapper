...
### Get Enabled Markers Only
`GET /api/markers/enabled`
...
{
  "name": "Accra Harbor",
  "description": "Main harbor entrance",
  "lat": 5.5209,
  "lng": -0.0175,
  "icon": "harbor",
  "color": "#00FF00",
...
### Get Enabled Hazards Only
`GET /api/hazards/enabled`
...
```json
{
  ...
  "description": "Dangerous shallow water - avoid at low tide",
  "lat": 5.5409,
  "lng": -0.0375,
  "radius": 500,
  "type": "danger",
